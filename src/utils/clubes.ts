...
export function normalizeClube(raw: unknown): Clube {
  return {
    ...
    prof: toUpperText(pickField(raw, ['Prof', 'Professor', 'Professores', 'Professores(as)', 'Professor(es)', 'prof', 'professor', 'professores(as)'], '-'), '-'),
    estag: toUpperText(pickField(raw, ['Estag', 'Estagiario', 'Estagiário', 'Estagiarios', 'Estagiários', 'Estagiários(as)', 'estag', 'estagiario', 'estagiário', 'estagiarios(as)'], '-'), '-'),
